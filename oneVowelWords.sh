...
### the word ends in a period, a comma, a colon, a semicolon or an ellipsis and if so, the character 
### is removed. Then the word is passed through a series of filters. If the word has only one vowel 
### it will be added to the array previously defined. After serch for the entire text file the array 
### is sorted alphabetically. Finally the array containing only words with one vowel is printed in 
### console.
